...
public class ClienteDAO extends AbstractDAO{
    ...
    private static final String INSERT = "INSERT INTO cliente (nome, sobrenome, cpf, rg, observacoes, telefone1, telefone2, telefone3, usuario_id, endereco_id, endereco_complemento, endereco_referencia, endereco_numero) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    private static final String UPDATE = "UPDATE cliente SET nome=?, sobrenome=?, cpf=?, rg=?, observacoes=?, telefone1=?, telefone2=?, telefone3=?, usuario_id=?, endereco_id=?, endereco_complemento=?, endereco_referencia=?, endereco_numero=? WHERE id=?";
    ...
    public void inserir(Cliente cliente ){
        try {
            try (PreparedStatement ps = conexao.prepareStatement(INSERT)) {
                ...
                ps.setString(5, cliente.getObservacoes());
                ps.setString(6, cliente.getTelefone1());
                ps.setString(7, cliente.getTelefone2());
                ps.setString(8, cliente.getTelefone1());
                ps.setObject(9, null);
                ps.setObject(10, cliente.getEnderecoId().getId());
                ps.setString(11, cliente.getEnderecoComplemento());
                ps.setString(12, cliente.getEnderecoReferencia());
                ps.setString(13, cliente.getEnderecoNumero());
    ...
    public List<Cliente> buscarPor(String key, String value){
        List<Cliente> clientes = new ArrayList<>();
        ...
        try {
            ...
            try ( // prepared statement para inserção
                 PreparedStatement ps = conexao.prepareStatement("SELECT * FROM cliente WHERE "+key+" LIKE ?")) {
