...
public class ClienteEditar extends javax.swing.JFrame {
     ...
     * @param cliente
     */
    public ClienteEditar(JDesktopPane jDesktopPane, Cliente cliente) {
        initComponents();
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addComponent(jTextFieldTelefone1, javax.swing.GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE))
                                            .addGap(26, 26, 26)
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if(formValido){
            ...
            JOptionPane.showMessageDialog(null, cliente.getNome() + " atualizado com sucesso");
            //Fecha jframe
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        if(comfirm == 0){
            new ClienteDAO().deletar(cliente.getId());
    ...
    private void populate(){
        ...
        jTextFieldTelefone1.setText(cliente.getTelefone1());
        jTextFieldTelefone2.setText(cliente.getTelefone2());
        jTextFieldTelefone3.setText(cliente.getTelefone3());
        jTextFieldCidade.setText(cliente.getEnderecoId().getCidade());
        jTextFieldBairro.setText(cliente.getEnderecoId().getBairro());
        jTextFieldLogradouro.setText(cliente.getEnderecoId().getLogradouro());
        jTextFieldCep.setText(cliente.getEnderecoId().getCep());
        jTextFieldEnderecoNumero.setText(cliente.getEnderecoNumero());
        jTextFieldEnderecoComplemento.setText(cliente.getEnderecoComplemento());
        
        DefaultListModel listModel = new DefaultListModel();
        listModel.addElement(cliente.getEnderecoId());
        jListEnderecos.setModel(listModel);
        jListEnderecos.setSelectedValue(cliente.getEnderecoId(), true);
   ...
   public void atualiza(){
        ...
        cliente.setTelefone1(jTextFieldTelefone1.getText());
